...
import com.firstapp.camerax.databinding.ActivityCameraBinding
import java.io.File
...
class CameraActivity : AppCompatActivity() {
    ...
    private val launcherIntentGallery = registerForActivityResult(
        ...
        if (result.resultCode == RESULT_OK) {
            ...
            val gal = Intent(this,ConfirmImageActivity::class.java)
            gal.putExtra("picture",myFile)
            gal.putExtra("isCamera",false)
            startActivity(gal)
        }
    }
}